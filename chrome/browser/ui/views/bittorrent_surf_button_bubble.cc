...
// static
BitTorrentSurfButtonBubble* BitTorrentSurfButtonBubble::ShowBubble(Browser* browser,
                                           views::View* anchor_view) {
  BitTorrentSurfButtonBubble* delegate = new BitTorrentSurfButtonBubble(browser, anchor_view);
...
void BitTorrentSurfButtonBubble::Init() {
  ui::ResourceBundle& rb = ui::ResourceBundle::GetSharedInstance();
  const gfx::Font& original_font = rb.GetFont(ui::ResourceBundle::MediumFont);

  views::Label* title = new views::Label(
      l10n_util::GetStringUTF16(IDS_SURF_BUTTON_BUBBLE_TITLE));
  title->SetFont(original_font.DeriveFont(2, gfx::Font::BOLD));

  views::Label* subtext =
      new views::Label(l10n_util::GetStringUTF16(IDS_SURF_BUTTON_BUBBLE_SUBTEXT));
...
BitTorrentSurfButtonBubble::BitTorrentSurfButtonBubble(Browser* browser, views::View* anchor_view)
...
BitTorrentSurfButtonBubble::~BitTorrentSurfButtonBubble() {
}

void BitTorrentSurfButtonBubble::OnWidgetActivationChanged(views::Widget* widget, bool active) {
